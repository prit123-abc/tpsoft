...
<section class="locations-section">
    <div style="min-height:10px !important;" class="container">
        ...
        <h2 class="locations-title">
            Our Locations in <span class="highlight">DELHI</span>
        </h2>

        <div class="locations-grid">

            <a href="/seo-company-in-punjabi-bagh" class="location-item">Punjabi Bagh</a>
            <a href="/seo-company-in-dwarka" class="location-item">Dwarka</a>
            <a href="/seo-company-in-janakpuri" class="location-item">Janakpuri</a>
            <a href="/seo-company-in-rajouri-garden" class="location-item">Rajouri Garden</a>

            <a href="/seo-company-in-karol-bagh" class="location-item">Karol Bagh</a>
            <a href="/seo-company-in-south-delhi" class="location-item">South Delhi</a>
            <a href="/seo-company-in-uttam-nagar" class="location-item">Uttam Nagar</a>
            <a href="/seo-company-in-green-park" class="location-item">Green Park</a>

            <a href="/seo-company-in-rohini" class="location-item">Rohini</a>
            <a href="/seo-company-in-paschim-vihar" class="location-item">Paschim Vihar</a>
            <a href="/seo-company-in-hauz-khas" class="location-item">Hauz Khas</a>
            <a href="/seo-company-in-connaught-place" class="location-item">Connaught Place</a>

            <a href="/seo-company-in-jor-bagh" class="location-item">Jor Bagh</a>
            <a href="/seo-company-in-model-town" class="location-item">Model Town</a>
            <a href="/seo-company-in-greater-kailash" class="location-item">Greater Kailash</a>
            <a href="/seo-company-in-saket" class="location-item">Saket</a>

            <a href="/seo-company-in-okhla" class="location-item">Okhla</a>
            <a href="/seo-company-in-mayur-vihar" class="location-item">Mayur Vihar</a>
            <a href="/seo-company-in-mayapuri" class="location-item">Mayapuri</a>
            <a href="/seo-company-in-tilak-nagar" class="location-item">Tilak Nagar</a>
